    ...
    <div class="flex flex-col gap-4 overflow-hidden">
        ...
        <div class="w-full flex justify-between">
            <div class="flex gap-4">
                <flux:button size="sm" class="hover:cursor-pointer w-30" variant="primary" icon="arrow-up-on-square" label="Export"> Save </flux:button>
                <flux:button size="sm" class="hover:cursor-pointer w-30" variant="subtle" label="Save"> Cancel </flux:button>
            </div>
            <flux:button size="sm" class="hover:cursor-pointer w-30" variant="danger" icon="trash" label="Delete"> Delete </flux:button>
        ...
        <div class="w-full flex flex-row gap-4 items-top">
            ...
            <div class="flex flex-col w-30 gap-4 items-center justify-center">
                ...
                <!-- Audio Upload -->
                <div class="w-full">
                    <flux:input type="file" wire:model="audio" size="sm" label="Audio File"/>
                </div>
            ...
            <div class="flex flex-col gap-4 w-full">
                <div class="w-full flex flex-row items-top gap-4">
                    <flux:input type="text" wire:model="title" size="sm" placeholder="ex: My New Echo"/>
                    <!-- Images / file upload -->
                    <div class="h-fit flex flex-row gap-4">
                    <!-- Images Upload -->
                    <flux:input type="file" wire:model="images" size="sm" multiple/>
                    <!-- Files Upload -->
                    <flux:input type="file" wire:model="files" size="sm" multiple/>
                    </div>
                </div>
